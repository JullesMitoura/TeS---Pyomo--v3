...
# from app.auxiliar_func.elv_plot import create_vle_plot
...
#             self.kij, self.calculated_data = model.run(experimental_data=self.experimental_data, mode=system_type.lower())
